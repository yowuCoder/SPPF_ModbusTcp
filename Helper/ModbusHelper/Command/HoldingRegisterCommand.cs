...
{
    public class HoldingRegisterCommand : ModbusCommand
    {
        public HoldingRegisterCommand(string ip, List<TaglistDTO> tagLists, DatabaseRepository dr) : base(ip, tagLists, dr)
        {
        ...
        public override async Task Execute()
        {
            try
            {
                ...
                {
                    InputRegisterTasks.Add(_mr.ReadHoldingRegistersAsync(_ipAddress, (ushort)(address - 1), 100));
                ...
                {
                    await HandleData();
                 //   await _dr.RealToHistoryByMedthodAsync("4", _tagList[0].host_id);
                }
